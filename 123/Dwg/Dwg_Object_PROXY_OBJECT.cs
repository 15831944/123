...
public class Dwg_Object_PROXY_OBJECT : global::System.IDisposable {
  ...
  public string data {
    set {
      LibreDWGPINVOKE.Dwg_Object_PROXY_OBJECT_data_set(swigCPtr, value);
    } 
    get {
      string ret = LibreDWGPINVOKE.Dwg_Object_PROXY_OBJECT_data_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public SWIGTYPE_p_p__dwg_object_ref objid_object_handles {
    set {
      LibreDWGPINVOKE.Dwg_Object_PROXY_OBJECT_objid_object_handles_set(swigCPtr, SWIGTYPE_p_p__dwg_object_ref.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = LibreDWGPINVOKE.Dwg_Object_PROXY_OBJECT_objid_object_handles_get(swigCPtr);
